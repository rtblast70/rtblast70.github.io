...
const Gallery = () => {
    ...
    let data = [
        ...
        {src: starry_1, caption: "Street lights in SLO are pretty much nonexistent. This is the upside"},
        ...
        {src: musical, caption: "Joined the musical because it seemed fun, turns out it was"},
    ...
    return (
        ...
        <div className="gallery">
            {data.map((item, index)=> {
                return (
                    <>
                    <div className="image" key={index} onClick={() => displayImg(item.src, item.caption)}>
